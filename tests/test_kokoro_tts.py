...
class TestKokoroTTSConfig:
    ...
    def test_voice_defaults_by_language(self) -> None:
...
class TestKokoroTTS:
    ...
    def test_engine_lazy_loading_without_kokoro_raises_error(self, monkeypatch) -> None:  # type: ignore[no-untyped-def]
...
class TestVoiceHelperFunctions:
    ...
    def test_get_supported_voices_english(self) -> None:
    ...
    def test_get_supported_voices_all_languages(self) -> None:
    ...
    def test_get_default_voice_invalid_language(self) -> None:
        """Test getting default voice for invalid language raises error."""
        with pytest.raises(ValueError, match="Unsupported language"):
            get_default_voice("klingon")

    def test_voice_mappings_consistency(self) -> None:
...
class TestKokoroTTSIntegration:
    ...
    @pytest.fixture
    def tts(self):  # type: ignore[no-untyped-def]
    ...
    def test_full_pipeline(self, tts) -> None:  # type: ignore[no-untyped-def]
